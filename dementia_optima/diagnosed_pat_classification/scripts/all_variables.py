...
df_data_comp_X_misdiag = drop_missing_columns(df_data_comp_X_misdiag[df_data_comp_X_misdiag.isna().sum(axis=1)<1505], 0.8) # thresold to decide about missing values 1506 in this case
...
df_X_y = df_data_comp[df_data_comp['outlier_label']==1]
